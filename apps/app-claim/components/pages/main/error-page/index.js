...
import { companyUrl, companyTitle } from 'app.config.js'
...
class ErrorPage extends React.Component {
  ...
  defineIcon ({ error }) {
    switch (error) {
      ...
      case 'LINK_EXPIRED':
        return <Icons.Clock fill={variables.blackColor} />
      case 'LINK_CANCELED':
        return <Icons.Cross fill={variables.blackColor} />
      default:
        return <Icons.Exclamation fill={variables.blackColor} />
    }
  }
}
